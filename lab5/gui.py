...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(500, 270))
        ...
        self.menu.addAction(self.createMB)
        self.menu.addAction(self.openMB)
        self.menu.addAction(self.saveMB)
        self.menu.addAction(self.saveAsMB)
        self.menu.addAction(self.exitMB)
        self.menu_2.addAction(self.infoMB)
